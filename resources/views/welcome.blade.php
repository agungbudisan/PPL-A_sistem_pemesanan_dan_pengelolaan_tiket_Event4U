...
<nav class="bg-[#7B0015] text-white py-6">
    <div class="container mx-auto flex justify-between items-center px-6">
        ...
        <ul class="flex space-x-6">
            <!-- Link yang harus berwarna #F7ECAC -->
    ...
    <!-- Footer -->
    <footer class="bg-[#7B0015] text-white py-6 mt-6">
        <div class="text-center">
            <p class="text-ls">2025 PT Tiket.in Indonesia. Created by Kelompok 4.</p>
        </div>
    </footer>
